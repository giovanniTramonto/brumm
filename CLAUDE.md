...
- **Vertragsende (contractEnd)**: Gespeichert in Sheets-Spalte N als Jahreszahl (z.B. `"2026"`). Das Vertragsjahr endet jeweils am 31. Juli — ein Kind mit `contractEnd = "2026"` wird ab August 2026 aus allen Berechnungen ausgeschlossen (`isContractActive()` in `utils/reimbursement.ts`).
