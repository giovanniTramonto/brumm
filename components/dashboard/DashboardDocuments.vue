...
const isVisible = computed(() => canManage.value || documents.value.length > 0)
</script>
...
<template>
  <div v-if="isVisible" class="card mt-6">
    <div class="mb-3 flex items-center justify-between">
      ...
      <NuxtLink v-if="canManage" :to="`/ini/${props.slug}/documents`" class="btn-secondary text-xs">Bearbeiten</NuxtLink>
    </div>
