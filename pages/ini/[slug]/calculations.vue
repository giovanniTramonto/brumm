              ...
              <div v-if="reimbursement.baseTotal > 0 || monthlyMembershipFees > 0" class="mt-4 space-y-1 border-t pt-3 text-sm text-gray-600">
                ...
                <template v-if="reimbursement.surchargeTotal > 0 || reimbursement.ndhChildCount > 0">
                  <div class="flex justify-between pt-0.5">
                    <span>Zuschläge</span>
                    <span class="font-mono">{{ formatEur(reimbursement.surchargeTotal) }}</span>
                  </div>
                  ...
                  <div v-if="reimbursement.qmSurchargeTotal > 0" class="flex justify-between pl-3 text-xs text-gray-500">
                    ...
                    <span class="font-mono">{{ formatEur(reimbursement.qmSurchargeTotal) }}</span>
                  </div>
                  <div v-if="reimbursement.integrationASurchargeTotal > 0" class="flex justify-between pl-3 text-xs text-gray-500">
                    ...
                    <span class="font-mono">{{ formatEur(reimbursement.integrationASurchargeTotal) }}</span>
                  </div>
                  <div v-if="reimbursement.integrationBSurchargeTotal > 0" class="flex justify-between pl-3 text-xs text-gray-500">
                    ...
                    <span class="font-mono">{{ formatEur(reimbursement.integrationBSurchargeTotal) }}</span>
                  </div>
                </template>
                <div v-if="reimbursement.baseTotal > 0" class="flex justify-between border-t pt-2 mt-1 font-medium text-gray-700">
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-baseline gap-3">
                ...
                <p v-if="authStore.currentClub?.membershipFee != null" class="text-sm text-gray-400">
                  <span class="font-mono">{{ formatEur(authStore.currentClub.membershipFee + getMealAllowance(currentYear, currentMonth)) }}</span> inkl. Essen
                </p>
              </div>
