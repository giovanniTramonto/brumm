...
async function onSubmit() {
  ...
  error.value = null
  try {
    await teamStore.createTeamMember(slug, form)
...
<template>
  <div>
    <NuxtLink :to="`/ini/${slug}/team`" class="mb-6 block text-sm text-gray-500 hover:text-gray-700">← Zurück</NuxtLink>

    <form class="card max-w-lg" @submit.prevent="onSubmit">
      <h1 class="mb-6 text-2xl font-bold text-gray-900">Teammitglied hinzufügen</h1>
